...
public class PlayerVariables {
    public double ability_cd = 0.0;
    public double skyrider_ab_dur = 0.0;
    public double dark_iron_sword_ab_dur = 0.0;
    public boolean dark_iron_sword_active = false;
    public double the_flute_ab_stack = 0.0;
    public double the_flute_ab_dur = 0.0;
    public double harmonics_destroy = 0.0;
    public double prototype_rancour_stack = 0.0;
    public double prototype_rancour_dur = 0.0;
    public double prototype_rancour_cd = 0.0;
    public double blackcliff_stacks = 0.0;
    public double blackcliff_st1 = 0.0;
    public double blackcliff_st2 = 0.0;
    public double blackcliff_st3 = 0.0;
    public double royal_stacks = 0.0;
    ...
    public void onUpdate() {
        if (this.ability_cd > 0.0) {
            this.ability_cd -= 1.0;
        }
        if (this.prototype_rancour_dur > 0.0) {
            this.prototype_rancour_dur -= 1.0;
        }
        if (this.prototype_rancour_dur == 0.0) {
            this.prototype_rancour_stack = 0.0;
        }
        if (this.prototype_rancour_cd > 0.0) {
            this.prototype_rancour_cd -= 1.0;
        }
        if (this.dark_iron_sword_ab_dur > 0.0) {
            this.dark_iron_sword_ab_dur -= 1.0;
        }
        if (this.blackcliff_st1 > 0.0) {
            this.blackcliff_st1 -= 1.0;
        }
        if (this.blackcliff_st2 > 0.0) {
            this.blackcliff_st2 -= 1.0;
        }
        if (this.blackcliff_st3 > 0.0) {
            this.blackcliff_st3 -= 1.0;
        }
        if (this.skyrider_ab_dur > 0.0) {
            this.skyrider_ab_dur -= 1.0;
        }
        if (this.the_flute_ab_dur > 0.0) {
            this.the_flute_ab_dur -= 1.0;
        }
    }
}
