...
extends ItemBaubleBaseModifier {
    ...
    public ItemMiningCharm() {
        super("mining_charm");
        this.maxStackSize = 1;
        this.setUnlocalizedName("mining_charm");
    ...
    public void addInformation(ItemStack par1ItemStack, World par2EntityPlayer, List<String> par3List, ITooltipFlag par4) {
        if (GuiScreen.isShiftKeyDown()) {
            par3List.add(I18n.format("item.ItemMiningCharm1.lore", (int)(RelicsConfigHandler.miningCharmBoost * 100.0f)));
            par3List.add(I18n.format("item.ItemMiningCharm2.lore", RelicsConfigHandler.miningCharmReach));
    ...
    void fillModifiers(Multimap<String, AttributeModifier> attributes, ItemStack stack) {
        attributes.put(EntityPlayer.REACH_DISTANCE.getName(), new AttributeModifier(ItemMiningCharm.getBaubleUUID(stack), "Mining Charm", (double)RelicsConfigHandler.miningCharmReach, 0).setSaved(false));
    }
}
